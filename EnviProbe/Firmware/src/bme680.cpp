...
{
void BME680::begin(Configuration &config)
{
    m_config = &config;
...
void BME680::loadBsecState(Configuration& config)
{
    const auto& state = config.bsecState();
...
void BME680::updateBsecState(Configuration& config)
{
    bool update = false;
